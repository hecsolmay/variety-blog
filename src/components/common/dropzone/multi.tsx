...
const variants = {
  base: 'relative rounded-md aspect-square flex justify-center items-center flex-col cursor-pointer min-h-[150px] min-w-[200px] border border-dashed border-primary transition-colors duration-200 ease-in-out',
  image:
          ...
          {value?.map(({ file, progress }, index) => (
            ...
            >
              ...
              {typeof progress === 'number' && (
                <div className='absolute left-0 top-0 flex size-full items-center justify-center rounded-md bg-black/70'>
              ...
              {imageUrls[index] && !disabled && progress === 'PENDING' && (
                ...
                >
                  <div className='flex size-5 cursor-pointer items-center justify-center rounded-md border border-solid border-gray-500 bg-white transition-all duration-300 hover:size-6'>
                    <X
          ...
          {(!value || value.length < (dropzoneOptions?.maxFiles ?? 0)) && (
            ...
            >
              ...
              <div className='flex flex-col items-center justify-center text-xs text-gray-600'>
                ...
                <div className='text-gray-600'>drag & drop to upload</div>
                <div className='mt-3'>
  ...
  return (
    <button
      ...
      className={twMerge(
        ...
        // color
        'border border-gray-400 text-gray-600 shadow hover:bg-gray-100 hover:text-gray-500',
        // size
