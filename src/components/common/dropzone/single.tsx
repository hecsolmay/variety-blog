...
const variants = {
  base: 'relative rounded-md flex justify-center items-center flex-col cursor-pointer min-h-[150px] min-w-[200px] border border-dashed border-primary transition-colors duration-200 ease-in-out',
  image:
      ...
      <div>
        ...
        >
          ...
          {imageUrl && !disabled && (
            ...
            >
              <div className='flex size-5 items-center justify-center rounded-md border border-solid border-gray-500 bg-white transition-all duration-300 hover:size-6'>
                <X
  ...
  return (
    <button
      ...
      className={twMerge(
        ...
        // color
        'border border-gray-400 text-gray-700 shadow hover:bg-gray-100 hover:text-gray-500',
        // size
